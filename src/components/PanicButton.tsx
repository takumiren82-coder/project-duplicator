...
export function PanicButton() {
  ...
  return (
    <button
      ...
      className="fixed z-50 flex h-[70px] w-[70px] touch-none select-none flex-col items-center justify-center rounded-full border-2 border-gold text-center shadow-lg"
    >
      <span
        className="absolute inset-0 rounded-full"
        style={{ background: "radial-gradient(circle at 30% 30%, oklch(0.55 0.2 25), oklch(0.3 0.12 25))" }}
      />
      <span className="relative z-10 font-heading text-[9px] font-bold leading-tight text-gold">
        PANIC
        <br />
        ALERT
      </span>
